    ...
    meta: [
      {
        name: "description",
        content:
          "Assista à reprise da Aula 2 do AULÃO ADV-IA enquanto está disponível e dê o próximo passo para uma advocacia de alta performance.",
      },
      { name: "robots", content: "noindex, nofollow" },
      { property: "og:title", content: "Replay Aula 2 — ADV-IA" },
      {
        property: "og:description",
        content: "Assista à reprise da Aula 2 enquanto está disponível.",
      },
    ],
  });
        ...
        <div className="mt-10 grid flex-1 items-center gap-10 lg:mt-16 lg:grid-cols-2 lg:gap-12">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="mt-6 font-display text-3xl font-normal leading-[1.1] text-balance sm:text-4xl md:text-5xl lg:text-6xl">
              Perdeu a <em className="text-[oklch(0.93_0.05_245)]">Aula 2</em>?
            </h1>
            ...
            <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-black/50 shadow-glow backdrop-blur">
              <div className="relative aspect-video w-full">
                <iframe
                  ...
                  src={YT_EMBED}
                  title="AULÃO ADV-IA — Replay Aula 2"
                  frameBorder={0}
