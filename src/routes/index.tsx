...
function LeadForm({ id = "lead", inline = false }: { id?: string; inline?: boolean }) {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="group relative inline-flex w-full items-center justify-center gap-2 rounded-lg bg-accent-gradient px-6 py-4 text-base font-bold uppercase tracking-wide text-[oklch(0.20 0 0)] shadow-glow transition-transform hover:-translate-y-0.5 active:translate-y-0"
      >
...
function CtaButton({ children, href = "#inscricao" }: { children: React.ReactNode; href?: string }) {
  return (
    <a
      href={href}
      className="group inline-flex items-center justify-center gap-2 rounded-lg bg-accent-gradient px-7 py-4 text-sm font-bold uppercase tracking-wider text-[oklch(0.20 0 0)] shadow-elegant transition-transform hover:-translate-y-0.5"
    >
      {children}
  ...
  return (
    <main className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden bg-hero text-white">
        ...
        <div className="absolute -top-32 -right-32 h-[28rem] w-[28rem] rounded-full bg-[oklch(0.62 0.20 250/0.18)] blur-3xl animate-float" />
        <div className="absolute -bottom-40 -left-20 h-[24rem] w-[24rem] rounded-full bg-[oklch(0.34 0 0/0.6)] blur-3xl" />

        <div className="relative mx-auto max-w-7xl px-6 pb-24 pt-10 lg:pt-16">
          <div className="max-w-3xl">
            <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-[oklch(0.62 0.20 250/0.4)] bg-[oklch(0.62 0.20 250/0.1)] px-3 py-1 text-xs font-medium uppercase tracking-widest text-[oklch(0.88 0.12 245)]">
            ...
            <h1 className="font-display text-4xl md:text-[2.5rem] lg:text-[2.75rem] font-normal leading-[1.2]">
              ...
              <br />
              <span className="italic text-[oklch(0.88 0.12 245)]">peticionando do mesmo jeito</span>
              <br />
              nos próximos 5&nbsp;anos?
            </h1>
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4 text-sm text-white/80">
              <span className="inline-flex items-center gap-2 rounded-full bg-white/5 px-3 py-1.5 ring-1 ring-white/10">
                <Calendar className="h-4 w-4 text-[oklch(0.62 0.20 250)]" /> 26 e 27 de maio
              </span>
              <span className="inline-flex items-center gap-2 rounded-full bg-white/5 px-3 py-1.5 ring-1 ring-white/10">
                <Clock className="h-4 w-4 text-[oklch(0.62 0.20 250)]" /> 19:51h
              </span>
              <span className="inline-flex items-center gap-2 rounded-full bg-white/5 px-3 py-1.5 ring-1 ring-white/10">
                <ShieldCheck className="h-4 w-4 text-[oklch(0.62 0.20 250)]" /> Evento ao vivo
              </span>
            </div>
          </div>
      ...
      <section className="relative bg-[oklch(0.985_0.005_120)] py-24">
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-3xl text-center">
            <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[oklch(0.34 0 0)]">
              Programação
            </span>
          ...
          <div className="mt-14 grid gap-6 lg:grid-cols-2">
            ...
            <article className="group relative overflow-hidden rounded-2xl border border-border bg-card p-8 shadow-elegant transition-transform hover:-translate-y-1">
              ...
              <div className="flex items-baseline justify-between">
                <span className="font-display text-6xl font-normal text-[oklch(0.27 0 0)]">
                  01
                </span>
              ...
              <ul className="mt-6 space-y-3 text-[15px]">
                {[
                  ...
                  <li key={t} className="flex gap-3">
                    <CheckCircle2 className="mt-0.5 h-5 w-5 flex-none text-[oklch(0.55 0.20 250)]" />
                    <span>{t}</span>
                  </li>
                ))}
              </ul>
            ...
            {/* DIA 2 */}
            <article className="group relative overflow-hidden rounded-2xl border border-border bg-[oklch(0.27 0 0)] p-8 text-white shadow-elegant transition-transform hover:-translate-y-1">
              <div className="absolute right-0 top-0 h-24 w-24 rounded-bl-[3rem] bg-accent-gradient opacity-30" />
              <div className="flex items-baseline justify-between">
                <span className="font-display text-6xl font-normal text-[oklch(0.88 0.12 245)]">
                  02
                </span>
              ...
              <ul className="mt-6 space-y-3 text-[15px]">
                {[
                  ...
                  <li key={t} className="flex gap-3">
                    <CheckCircle2 className="mt-0.5 h-5 w-5 flex-none text-[oklch(0.62 0.20 250)]" />
        ...
        <div className="mx-auto max-w-7xl px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-3 font-display text-4xl font-normal leading-tight text-balance md:text-5xl">
              ...
              <em className="text-[oklch(0.34 0 0)]">Desafio Prática Jurídica com IA?</em>
            </h2>
          </div>

          <div className="mt-14 grid gap-6 md:grid-cols-2">
            <div className="rounded-2xl border-2 border-[oklch(0.62 0.20 250/0.3)] bg-[oklch(0.96 0.04 245/0.4)] p-8">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-[oklch(0.62 0.20 250)] text-white">
              ...
              <ul className="mt-6 space-y-4 text-[15px] leading-relaxed">
                {[
                  ...
                  <li key={t} className="flex gap-3">
                    <span className="mt-2 h-1.5 w-1.5 flex-none rounded-full bg-[oklch(0.55 0.20 250)]" />
                    <span>{t}</span>
                  </li>
                ))}
              </ul>
      ...
      <section className="relative overflow-hidden bg-hero py-24 text-white">
        ...
        <div className="absolute right-0 top-1/2 h-96 w-96 -translate-y-1/2 rounded-full bg-[oklch(0.62 0.20 250/0.12)] blur-3xl" />
        <div className="mx-auto grid max-w-7xl gap-14 px-6 lg:grid-cols-[1fr,1.4fr] lg:items-center">
          <div className="relative">
            <div className="relative mx-auto aspect-[4/5] max-w-sm overflow-hidden rounded-2xl border border-white/10 bg-[oklch(0.34 0 0)] shadow-elegant">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  <div className="mx-auto flex h-32 w-32 items-center justify-center rounded-full bg-accent-gradient text-5xl font-display font-normal text-[oklch(0.20 0 0)] shadow-glow animate-pulse-ring">
                    TS
                  </div>
              ...
              <div className="absolute -bottom-1 left-0 right-0 h-32 bg-gradient-to-t from-[oklch(0.27 0 0)] to-transparent" />
            </div>
          </div>
          <div>
            <span className="text-xs font-semibold uppercase tracking-[0.2em] text-[oklch(0.88 0.12 245)]">
              Quem ensina
            </span>
            <h2 className="mt-3 font-display text-4xl font-normal leading-tight text-balance md:text-5xl">
              Quem é <em className="text-[oklch(0.88 0.12 245)]">Thiago Sobral</em>?
            </h2>
            <div className="mt-7 space-y-5 text-[17px] leading-relaxed text-white/85">
              ...
              <p className="text-[oklch(0.88 0.12 245)] font-display italic text-xl">
            ...
            <div className="mt-8 grid grid-cols-3 gap-3 text-center">
              {[
                ...
                >
                  <Icon className="mx-auto h-5 w-5 text-[oklch(0.62 0.20 250)]" />
        ...
        <div className="mx-auto max-w-5xl px-6">
          <div className="text-center">
            <h2 className="font-display text-4xl font-normal leading-tight text-balance md:text-5xl">
              ...
              <em className="text-[oklch(0.34 0 0)]">Resultado na sua prática.</em>
            </h2>
