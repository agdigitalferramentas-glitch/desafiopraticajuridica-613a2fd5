...
const WHATSAPP_GROUP_URL = "https://chat.whatsapp.com/BUVcJPQMUeA7BVcmL4gIcA";
...
export default function AdvIaObgPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-background text-white">
      ...
      <a
        href="https://niucursos.com.br/suporte"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Suporte no WhatsApp"
        className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition-transform hover:scale-110 animate-pulse-ring"
      >
